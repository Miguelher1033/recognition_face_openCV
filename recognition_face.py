...
def recognition_face():
    ...
    rootPath = os.getcwd()
    path = rootPath + "/Cascades/haarcascade_frontalface_alt2.xml"
    faceCascade = cv2.CascadeClassifier(path)

    eyeCascade = cv2.CascadeClassifier(rootPath + "/Cascades/haarcascade_eye.xml")
    smileCascade = cv2.CascadeClassifier(rootPath + "/Cascades/haarcascade_smile.xml")
